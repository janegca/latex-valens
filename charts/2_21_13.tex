% Valens Book II.22 13th example chart
...
\begin{tikzpicture}[rotate=90, scale=3.5]
	...
	\node         at (75:0.8) {\Mercury};  %$13^\circ$};
		
	\node         at (95:0.8) {\Venus};    %$21^\circ$};			

	\node         at (290:0.8) {\Moon};     %$16^\circ$};
			

	\node         at (305:0.8) {\Mars};     %$27^\circ$}; 		
	\node         at (315:0.8) {\Saturn}; 
	
	\node         at (225:0.8) {\Jupiter};  %$ 3^\circ$};	
