% Valens Book V.09.1 54th example chart GH L120,II
...
\begin{scope}[rotate=15]
	...
	% --- draw planets
	\node         at (310:0.75) {\Sun};      
	\node         at (318:0.75) {\Mercury};  
	\node         at (213:0.75) {\Moon};     
	\node         at (295:0.75){\Venus};    
	\node         at (93:0.75) {\Saturn};
	\node         at (203:0.75) {\Jupiter};  
	\node         at (172:0.75) {\Mars};     
