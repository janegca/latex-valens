% Valens Book II.22 5th example chart
...
\begin{tikzpicture}[rotate=0, scale=3.5]
	...
	\node         at (253:0.8) {\Mercury};  %$13^\circ$}; 
	\node         at (260:0.8) {\Saturn};
	\node         at (267:0.8) {\Jupiter};  %$ 3^\circ$};	
	 
	\node         at (100:0.8) {\Moon};     %$16^\circ$};
		 
	\node         at (165:0.8) {\Mars};     %$27^\circ$}; 
	
	\node         at (185:0.8) {\Venus};    %$21^\circ$};	
	\node			 at (345:0.8) {\Fortune};    	
