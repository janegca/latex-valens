% Valens Book II.26.4 example chart GH L101,III
...
\begin{scope}[rotate=45]
	...
	% --- draw planets
	\node at (195:0.75) [blue] {\large\Moon};	
	\node at (335:0.75) [blue] {\Large\Sun};
	\node at (225:0.75) {\Saturn}; 
	\node at (345:0.75) {\Jupiter};	
	\node at (105:0.75) [blue] {\Large\Mars};
	\node at (355:0.75) [blue] {\Large\Venus};			
	\node at (315:0.75) {\Mercury};
		
	% -- draw Lots
	\pic at (345:0.6) {fortune};  
	\pic at (285:0.6){daimon};		
	\pic at (195:0.6){lot=B};				% Basis 
