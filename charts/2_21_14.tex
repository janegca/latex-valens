% Valens Book II.21 14th example chart GH L62
...
\begin{scope}[rotate=-165]
	...
	% --- draw planets
	\node at (315:0.75) [blue] {\LARGE\Sun};      
	\node at (275:0.75) {\Mars};     	
	\node at (285:0.75) {\Venus};   
	\node at (295:0.75) [blue] {\Large\Mercury};  
	\node at (220:0.75) {\Moon};     
	\node at (230:0.75) [blue] {\large\Jupiter};  			
	\node at (105:0.75) [blue] {\LARGE\Saturn}; 
		
	% -- Lots	
	\pic at (255:0.6) {fortune};    	
