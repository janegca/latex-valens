% Valens Book II.21.3 Third example chart GH L85
...
%     	(0,0) -- (240:.85) arc (240:270:.85);	 
	\scoped[on background layer]\filldraw[purple!10]
	 	(0,0) -- (300:.85) arc (300:330:.85);
 	 \scoped[on background layer]\filldraw[yellow!20]
     	(0,0) -- (180:.85) arc (180:210:.85);
 	 \scoped[on background layer]\filldraw[green!10]
     	(0,0) -- (330:.85) arc (330:360:.85);

     		
	% --- draw planets
	\node at (323:0.75) [blue] {\LARGE\Sun};     
	\node at (305:0.6) [blue] {\Large\Mercury};    
	\node at (305:0.75) {\Mars};    
	\node at (325:0.6) {\Venus};        	
	\node at (220:0.75) {\Moon};     
	\node at (230:0.75) [blue] {\Large\Jupiter};  
	\node at (15:0.75) [blue] {\Large\Saturn};   
	
	% -- Lots
	\pic at (45:0.75) {fortune};
