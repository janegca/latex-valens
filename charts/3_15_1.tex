% Valens Book II.22 7th example chart
...
\begin{tikzpicture}[rotate=0, scale=3.5]
   ...
   \draw [->, red, dashed, ultra thick] 
	...
	% --- draw planets
	\node         at ( 95:0.8) {\Sun};      %$ 1^\circ$}; 
	\node         at (115:0.8) {\Mercury};  %$13^\circ$}; 
	
	\node         at ( 45:0.8) {\Moon};     %$16^\circ$};
	\node         at (155:0.8) {\Venus};    %$21^\circ$};	
	\node [red]   at ( 95:0.6) {\Venus};	
		
	\node         at (335:0.8) {\Saturn};
	
	\node         at (125:0.8) {\Jupiter};  %$ 3^\circ$};	
	\node         at (135:0.8) {\Mars};     %$27^\circ$}; 
