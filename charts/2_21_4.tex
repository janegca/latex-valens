% Valens Book II.21.4 4th example chart GH L83
...
\begin{scope}[rotate=45]
	...
	% --- draw planets
	\node  [blue]		at (35:0.75) {\LARGE\Sun};      
	\node  [black!40]	at (50:0.75) {\Mercury};  
	\node         			at (345:0.75) {\Mars};     
	\node  [blue]		at (310:0.75) {\Large\Moon};     
	\node  [blue]		at (165:0.75) {\Large\Jupiter}; 
	\node         			at (25:0.75) {\Saturn};   
	\node  [blue]		at (15:0.75) {\Large\Venus};    	    	
	\node         			at (45:0.5) {\Fortune};
