% Valens Book II.26.3 example chart GH L78
...
\begin{scope}[rotate=165]
	...
	% --- draw planets
	\node at (25:0.75) {\Moon};	
	\node at (15:0.75) [blue]{\Large\Sun};
	\node at (310:0.75) [blue]  {\large\Saturn}; 
	\node at (285:0.75) [red!50] {[\Saturn]};
	\node at (3:0.75) [blue]{\Large\Jupiter};	
	\node at (75:0.75)  {\Mars};
	\node at (45:0.75) [red!50] {[\Mars]};
	\node at (320:0.75) {\Venus};			
	\node at (345:0.75) {\Mercury};
		
	% -- draw Lots
	\pic at (15:0.6) {fortune};   
	\pic at (15:0.45) {daimon};
	\pic at (15:0.3) {lot=B};
