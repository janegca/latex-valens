% Valens Book II.36.7 26th example chart GH L92
...
\begin{scope}[rotate=315]
	...
	% --- draw planets
	\node at (222:0.75) {\Moon};	
	\node at (215:0.75) {\Sun};
	\node at (135:0.75) {\Saturn}; 
	\node at (105:0.75) {\Jupiter};	
	\node at (285:0.75) {\Mars};
	\node at (195:0.75) {\Venus};			
	\node at (233:0.75) {\Mercury};
		
	% -- draw Lots
	\pic at (218:0.6) {fortune};
	\pic at (233:0.6) {daimon};
	\pic at (225:0.45) {lot=B}; 				% Basis
