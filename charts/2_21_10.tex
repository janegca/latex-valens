% Valens Book II.21 10th example chart GH L65 X
...
\begin{scope}[rotate=-75]
	...
	% --- draw planets
	\node at (220:0.75) [blue] {\LARGE\Sun};      
	\node at (230:0.75) {\Mercury};  
	\node at (15:0.75) [blue] {\large\Moon};     
	\node at (165:0.75) {\Saturn}; 
	\node at (130:0.75) [blue] {\Large\Mars};    
	\node at (260:0.75) [blue] {\Large\Venus};   		
	\node at (345:0.75) {\Jupiter};  
		
	% -- Lots
	\node			 at (45:0.6) {\Fortune};    	
