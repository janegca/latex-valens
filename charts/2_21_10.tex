% Valens Book II.22 10th example chart
...
\begin{tikzpicture}[rotate=-60, scale=3.5]
	...
	% --- draw planets
	\node         at (220:0.8) {\Sun};      %$ 1^\circ$};
	\node         at (225:0.8) {\Mercury};  %$13^\circ$};
	
	\node         at (15:0.8) {\Moon};     %$16^\circ$};
	
	\node         at (165:0.8) {\Saturn}; 
	
	\node         at (130:0.8) {\Mars};     %$27^\circ$}; 	
	\node         at (260:0.8) {\Venus};    %$21^\circ$};			
