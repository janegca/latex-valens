% Valens Book II.22 4th example chart
%		AND Book II.36.8 27th chart
...
\begin{tikzpicture}[rotate=60, scale=3.5]
	...
	\node         at (345:0.8) {\Mars};     %$27^\circ$}; 
	   
	\node         at (310:0.8) {\Moon};     %$16^\circ$};
	\node         at (160:0.8) {\Jupiter};  %$ 3^\circ$};
	
	\node         at (25:0.8) {\Saturn};   %$10^\circ$};
