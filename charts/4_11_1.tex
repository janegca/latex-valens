% Valens Book IV.11.1, also Book II.30.1 19a example chart GH L120
...
\begin{scope}[rotate=15]
	...
	% --- draw planets
	\node         at (315:0.7) {\Sun};       
	\node         at (325:0.7) {\Mercury};  
	\node         at (225:0.7) {\Moon};
	\node         at (105:0.7) {\Saturn}; 			
	\node         at (195:0.7) {\Jupiter};  
	\node         at (285:0.7) {\Venus};    					
	\node         at (160:0.7) {\Mars};   
		
	\pic at (285:0.55) {fortune};    
