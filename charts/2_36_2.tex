% Valens Book II.36.2 21st example chart GH L118
...
\begin{scope}[rotate=255]
	...
	% --- draw planets
	\node at (195:0.75) {\Moon};	
	\node at (245:0.75) {\Sun};
	\node at (75:0.75) {\Saturn}; 
	\node at (115:0.75)[red] {[\Saturn]}; 
	\node at (165:0.75) {\Jupiter};	
	\node at (265:0.75) {\Mars};
	\node at (255:0.75) {\Venus};			
	\node at (225:0.75) {\Mercury};
	\node at (290:0.75) [red]{[\Mercury]};
		
	% -- draw Lots
	\pic at (225:0.6) {fortune};
	\pic at (345:0.6) {daimon};
	\pic at (45:0.6) {lot=B}; 				% Basis
