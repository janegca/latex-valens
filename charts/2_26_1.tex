% Valens Book II.26.1 example chart GH L188
...
\begin{scope}[rotate=-15]
	...
	% --- draw planets
	\node at (132:0.75) {\Moon};	
	\node at (125:0.75) [blue] {\Large\Sun};
	\node at (185:0.75) [blue] {\large\Saturn}; 
	\node at (138:0.75) [blue] {\Large\Jupiter};	
	\node at (75:0.75) {\Mars};
	\node at (105:0.75) {\Venus};			
	\node at (145:0.75) {\Mercury};
		
	% -- draw Lots
	\pic at (205:0.75) {fortune};
	\pic at (204:0.6) {daimon};
	\pic at (203:0.45) {lot=B}; 				% Basis
