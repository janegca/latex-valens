% Valens Book II.22 8th example chart
...
\begin{tikzpicture}[rotate=60, scale=3.5]
	...
	\node         at (220:0.8) {\Jupiter};  %$ 3^\circ$};	
	\node         at (225:0.8) {\Mars};     %$27^\circ$}; 	
	\node         at (230:0.8) {\Venus};    %$21^\circ$};			
		
	\node         at (245:0.8) {\Mercury};  %$13^\circ$}; 
	
	\node         at ( 15:0.8) {\Moon};     %$16^\circ$};
		
	\node         at (195:0.8) {\Saturn};
