% Valens Book II.21 8th example chart GH L97
	...
	% -- Colour house
	 ...
	 \scoped[on background layer]\filldraw[purple!10]
 	 ...
 	 \scoped[on background layer]\filldraw[yellow!20]
     	(0,0) -- (150:.85) arc (150:180:.85);	   	    
 	 \scoped[on background layer]\filldraw[green!10]
     	(0,0) -- (270:.85) arc (270:300:.85);	 
	
	% --- draw planets
	\node  at (215:0.75) [blue] {\large\Sun};    
	\node  at (223:0.75) [blue] {\Large\Jupiter};  
	\node  at (230:0.75) {\Mars};     
	\node  at (237:0.75) {\Venus};   			
	\node  at (255:0.75) {\Mercury};  ; 
	\node  at ( 15:0.75) [blue] {\LARGE\Moon};     
	\node  at (195:0.75) [blue] {\large\Saturn};
