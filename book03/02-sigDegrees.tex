...
\index{degrees!operative}
\index{degrees!powerful}
\index{planets!powerful}
...
\end{figure}
\index{degrees!average}
\index{planets!average}
...
\index{degrees!crisis-producing}
\index{planets!crisis-producing}
