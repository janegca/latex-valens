...
\textbf{Comment:} \hfill \\
As Robert Hand mentions in the VRS3 translation, the planet years, as shown Table 3.2 above, are not as given in the majority of sources, but rather as Valens mentions them in the paragraph below. For reference, here is a table of Planet Years as they are usually given:
\end{mdframed}
