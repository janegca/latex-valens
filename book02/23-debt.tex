...
The Lot of Debt is calculated \mn{Calc.} by determining the distance from \Mercury\xspace to \Saturn\xspace then counting that same distance from the Ascendant. 
