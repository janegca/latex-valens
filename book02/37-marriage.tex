...
\index{planets!\Sun-\Jupiter-\Venus}
...
\index{planets!\Venus-\Mercury-\Moon}
...
Generally speaking, \Jupiter\, in aspect with \Venus\, from the right, being familiar with \Venus, or in agreement to the degree\mn{\tiny Exact \\ Degree}, causes sociable men, those helped by women (or for women, those helped by men). Even if \Venus\, is afflicted, <\Jupiter> helps so that not the native is not entirely ruined.
