...
\index{parents!separation}
\Mars\, and \Saturn, when intercepting\mn{Aspect Intercept} the luminaries or when situated between the <signs> which contain the luminaries, or between their rays, separate parents. 
...
If \Saturn\, is just leaving an angle, and if it is just approaching \Mars, and if either of them is in aspect with \Jupiter\, or the \Sun, the father will die abroad.
