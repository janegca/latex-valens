...
The Lot of the Father\mn{Lot of the Father} is found as follows: for day births determine the distance from the \Sun\xspace to \Saturn\xspace and count this distance from the Ascendant. (Some determine the \Sun\xspace to \Jupiter\xspace and count from the Ascendant.) \textsl{[To calculate the Lot of the Mother]}\mn{Lot of Mother} For night births, determine the distance from \Venus\xspace to the \Moon\xspace and count this distance from the Ascendant. 
