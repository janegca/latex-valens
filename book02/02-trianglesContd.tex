...
\index{technique!triplicity rulers}
...
\index{technique!triplicity rulers!timing}
\textbf{/57K/} \mn{timing} For nativities which are badly situated (whether day or night births), if the predominant
...
If both houserulers are well situated, good fortune will be enduring and will be remarkable (unless some malefic is opposed or in superior aspect), and the nativity will not take a turn for the worse. 
...
\mndl[0.2cm] \index{delineation!sect}
...
\marginnote{\Fortune}[0.3cm] \index{delineation!Fortune}
...
\index{planets!\Mars!aspects}
\index{planets!\Saturn-\Jupiter-\Sun}
\index{planets!malefic as benefic}
...
\mnbm[0.2cm] \index{planets!benefic as malefic}
